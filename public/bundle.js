...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CreatePost = __webpack_require__(165);
	
	var _CreatePost2 = _interopRequireDefault(_CreatePost);
	
	var _WpApi = __webpack_require__(168);
	
	var WpApi = _interopRequireWildcard(_WpApi);
	...
	var App = exports.App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          null,
	          'Simple React + Wordpress REST API plugin'
	        ),
	        _react2.default.createElement(_CreatePost2.default, { onSubmit: this.createPost }),
	    ...
	    value: function fetchPosts() {
	      ...
	      WpApi.get('wp/v2/posts').end(function (err, res) {
	        if (err) {
	          _this2.setState({
	            posts: [],
	            message: 'Error',
	    ...
	    key: 'createPost',
	    value: function createPost(values) {
	      var _this3 = this;
	
	      this.addTemporaryFakePost(values);
	
	      WpApi.post('wp/v2/posts').send(values).end(function (err, res) {
	        if (err) {
	          console.log(err);
	        }
	        _this3.fetchPosts();
	    ...
	    key: 'addTemporaryFakePost',
	    value: function addTemporaryFakePost(postValues) {
	          ...
	          _react2.default.createElement(
	            ...
	            posts.map(function (post) {
	              return _react2.default.createElement(
	                ...
	                _react2.default.createElement('td', { dangerouslySetInnerHTML: { __html: post.excerpt.rendered } })
	              );
	            })
	          )
	        )
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/index.js!./Posts.less", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/index.js!./Posts.less");
	...
	var CreatePost = function (_React$Component) {
	  ...
	  _createClass(CreatePost, [{
	    ...
	    value: function renderForm() {
	      ...
	      return _react2.default.createElement(
	        'form',
	        { className: 'CreatePost-form', onSubmit: this.onSubmit },
	        _react2.default.createElement(
	          'label',
	          null,
	          _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('textarea', { name: 'excerpt' })
	        ),
	        _react2.default.createElement(
	          'button',
	          { type: 'submit' },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/less-loader/index.js!./CreatePost.less", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/less-loader/index.js!./CreatePost.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function get(endpoint) {
	  return request.get(getApiLink(endpoint)).accept('application/json').set('X-WP-Nonce', API_Config.nonce);
	}
	
	function post(endpoint) {
	  return request.post(getApiLink(endpoint)).accept('application/json').set('X-WP-Nonce', API_Config.nonce);
	}
